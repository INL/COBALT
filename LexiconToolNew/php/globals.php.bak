...
$sDbHostName = "impactdb"; // Voor << << << dev !! !! !!
$sDbUserName = "impact";
$sDbPassword = "impact";

// There is a separate token database.
// It needs to have the same user name/password combinations as other database.
// All available databases use it (which is why there is only one). 
$sTokenDbName = 'lexiconToolTokenDb';
...
//          ////============================================\\\\
//
$sLogFile = "/mnt/Archief/Projecten/Impact/LexiconTool/LexiconToolLog/log.txt";
//$sLogFile = "/Users/mactommy/Sites/INL/LexiconToolLog/log.txt"; // Thuis
