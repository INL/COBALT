...
function changeWordForm($iUserId, $iOldWordFormId, $sOldWordForm,
  ...
  // First, if somethone typed in something totally meaningless, such as
  ...
  // MF: as the roundUp command is called only at the beginning of each round of the previous loop
  //    (so it is applied to the data of the previous round) we still need to roundUp the 
  //    data of the very last round, so we do it here:  
  if(! $bError) {
