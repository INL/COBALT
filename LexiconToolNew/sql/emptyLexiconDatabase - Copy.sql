...
--
-- Table structure for table `wordform_group`
--
...
CREATE TABLE `lemmata` (
  ...
  UNIQUE KEY `lemmaKeyTuple` (`modern_lemma`(100),`gloss`(100),`lemma_part_of_speech`(10),`ne_label`(10), language_id),
...
CREATE TABLE `token_attestations` (
  ...
  `end_pos` bigint unsigned NOT NULL,
  PRIMARY KEY  (`attestation_id`),
  UNIQUE KEY `tlaKey` (`analyzed_wordform_id`,derivation_id, `document_id`,`start_pos`,`end_pos`),
...
CREATE TABLE `wordforms` (
  ...
  `wordform_lowercase` varchar(255) COLLATE utf8_bin NOT NULL,
